...
\title{An introduction to relevant tools for economic analysis}

\author[a]{Jakob Jul Elben}

  \affil[a]{Department of Economics, University of Copenhagen, Øster Farimagsgade 5,
Building 26, 1353 Copenhagen K}
...
\begin{abstract}
This document gives a thorough introduction to the main tools you will
meet in your position as research assistant at Department of Economics.
\end{abstract}

\dates{This version was compiled on \today}
\doi{\url{https://www.github.com/elben10/}}
...
{\centering \includegraphics{IntroductionResearchAssistants_files/figure-latex/figex-1} 
