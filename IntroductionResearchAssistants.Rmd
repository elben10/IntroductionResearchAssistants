---
title: An introduction to relevant tools for economic analysis
...
address:
  - code: a
    address: Department of Economics, University of Copenhagen, Øster Farimagsgade 5, Building 26, 1353 Copenhagen K

# For footer text  TODO(fold into template, allow free form two-authors)
lead_author_surname: Author and Author

# Place DOI URL or CRAN Package URL here
doi: "https://www.github.com/elben10/"

# Abstract
abstract: |
  This document gives a thorough introduction to the main tools you will meet in your position as research assistant at Department of      Economics.
